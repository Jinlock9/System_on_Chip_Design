    ...
    for (int i = 0; i < 18; i++) {
        switch (i) {
            case 0:
                ...
                *(baseaddr_rtl_alu + 1) = 0x00000005; // opb = 5
                *(baseaddr_rtl_alu + 2) = 0x00000000; // func = ALU_ADD
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;
            ...
            case 1:
                ...
                *(baseaddr_rtl_alu + 0) = 0x0000000a; // opa = 10
                *(baseaddr_rtl_alu + 1) = 0x00000005; // opb = 5
                *(baseaddr_rtl_alu + 2) = 0x00000001; // func = ALU_SUB
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;

            case 2:
                xil_printf("TEST #2: ALU_SLT\r\n");
                *(baseaddr_rtl_alu + 0) = 0xFFFFFFF6; // opa = -10
                *(baseaddr_rtl_alu + 1) = 0x00000005; // opb = 5
                *(baseaddr_rtl_alu + 2) = 0x00000002; // func = ALU_SLT
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;
            ...
            case 3:
                ...
                *(baseaddr_rtl_alu + 0) = 0x0000000a; // opa = 10
                *(baseaddr_rtl_alu + 1) = 0x00000014; // opb = 20
                *(baseaddr_rtl_alu + 2) = 0x00000003; // func = ALU_SLTU
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;

            case 4:
                xil_printf("TEST #4: ALU_AND\r\n");
                *(baseaddr_rtl_alu + 0) = 0x00000006; // opa = 6
                *(baseaddr_rtl_alu + 1) = 0x00000003; // opb = 3
                *(baseaddr_rtl_alu + 2) = 0x00000004; // func = ALU_AND
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;
            ...
            case 5:
                ...
                *(baseaddr_rtl_alu + 0) = 0x00000006; // opa = 6
                *(baseaddr_rtl_alu + 1) = 0x00000003; // opb = 3
                *(baseaddr_rtl_alu + 2) = 0x00000005; // func = ALU_OR
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;
            ...
            case 6:
                ...
                *(baseaddr_rtl_alu + 0) = 0x00000006; // opa = 6
                *(baseaddr_rtl_alu + 1) = 0x00000003; // opb = 3
                *(baseaddr_rtl_alu + 2) = 0x00000006; // func = ALU_XOR
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;

            case 7:
                xil_printf("TEST #7: ALU_SLL\r\n");
                *(baseaddr_rtl_alu + 0) = 0x00000005; // opa = 5
                *(baseaddr_rtl_alu + 1) = 0x00000001; // opb = 1
                *(baseaddr_rtl_alu + 2) = 0x00000007; // func = ALU_SLL
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;
            ...
            case 8:
                ...
                *(baseaddr_rtl_alu + 0) = 0x0000000a; // opa = 10
                *(baseaddr_rtl_alu + 1) = 0x00000001; // opb = 1
                *(baseaddr_rtl_alu + 2) = 0x00000008; // func = ALU_SRL
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;

            case 9:
                xil_printf("TEST #9: ALU_SRA\r\n");
                *(baseaddr_rtl_alu + 0) = 0xFFFFFFFC; // opa = -4
                *(baseaddr_rtl_alu + 1) = 0x00000001; // opb = 1
                *(baseaddr_rtl_alu + 2) = 0x00000009; // func = ALU_SRA
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;
            ...
            case 10:
                ...
                *(baseaddr_rtl_alu + 0) = 0x00000005; // opa = 5
                *(baseaddr_rtl_alu + 1) = 0x00000003; // opb = 3
                *(baseaddr_rtl_alu + 2) = 0x0000000A; // func = ALU_MUL
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;

            case 11:
                xil_printf("TEST #11: ALU_MULH\r\n");
                *(baseaddr_rtl_alu + 0) = 0x000186A0; // opa = 100000
                *(baseaddr_rtl_alu + 1) = 0x000186A0; // opb = 100000
                *(baseaddr_rtl_alu + 2) = 0x0000000B; // func = ALU_MULH
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;
            ...
            case 12:
                ...
                *(baseaddr_rtl_alu + 0) = 0x000186A0; // opa = 100000
                *(baseaddr_rtl_alu + 1) = 0x000186A0; // opb = 100000
                *(baseaddr_rtl_alu + 2) = 0x0000000C; // func = ALU_MULHSU
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;
            ...
            case 13:
                ...
                *(baseaddr_rtl_alu + 0) = 0x000186A0; // opa = 100000
                *(baseaddr_rtl_alu + 1) = 0x000186A0; // opb = 100000
                *(baseaddr_rtl_alu + 2) = 0x0000000D; // func = ALU_MULHU
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;
            ...
            case 14:
                ...
                *(baseaddr_rtl_alu + 0) = 0x0000000A; // opa = 10
                *(baseaddr_rtl_alu + 1) = 0x00000005; // opb = 5
                *(baseaddr_rtl_alu + 2) = 0x0000000E; // func = ALU_DIV
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;
            ...
            case 15:
                ...
                *(baseaddr_rtl_alu + 0) = 0x0000000A; // opa = 10
                *(baseaddr_rtl_alu + 1) = 0x00000003; // opb = 3
                *(baseaddr_rtl_alu + 2) = 0x0000000F; // func = ALU_DIVU
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;
            ...
            case 16:
                ...
                *(baseaddr_rtl_alu + 0) = 0x0000000A; // opa = 10
                *(baseaddr_rtl_alu + 1) = 0x00000003; // opb = 3
                *(baseaddr_rtl_alu + 2) = 0x00000010; // func = ALU_REM
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;
            ...
            case 17:
                ...
                *(baseaddr_rtl_alu + 0) = 0x0000000A; // opa = 10
                *(baseaddr_rtl_alu + 1) = 0x00000003; // opb = 3
                *(baseaddr_rtl_alu + 2) = 0x00000011; // func = ALU_REMU
                xil_printf("opa: 0x%02x, opb: 0x%02x, result: 0x%08x \r\n", *(baseaddr_rtl_alu + 0), *(baseaddr_rtl_alu + 1), *(baseaddr_rtl_alu + 3));
                break;
